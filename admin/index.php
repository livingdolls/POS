...
<head>
  ...
  <script src="assets/dt.js"></script>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="admin/img/<?= $datauser['foto'] ?>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?= $datauser['nama_admin']; ?>
                  <small>Member since <?= $datauser['create_at']; ?></small>
                </p>
              </li>
              <!-- Menu Footer-->
...
<script src="assets/DataTables/DataTables/js/dataTables.bootstrap.min.js"></script> <!--DataTables Theme-->
...
<!-- Jquery Ajax -->
<script src="template/Barang.js"></script>
<script src="template/Admin.js"></script>
<script src="template/Kategori.js"></script>
<script src="template/MasterBarang.js"></script>
<script src="template/Laporan.js"></script>
<script src="template/Main.js"></script>
<script src="template/Supplier.js"></script>
<script src="template/Log.js"></script>
</body>
</html>
