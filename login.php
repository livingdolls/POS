<?php
    ...
    if(isset($_POST['login']))
    {
        ...
        $sql = $konek->query("SELECT * FROM `admin` WHERE `email_admin` = '$mail' AND `password` = '$pass'");
        ...
        {
            echo 'Cek kembali email dan password';
        }
...
<div class="login-box">
  <div class="login-logo">
      <span class="label label-primary">Login Admin</span>
  </div>
  <!-- /.login-logo -->
